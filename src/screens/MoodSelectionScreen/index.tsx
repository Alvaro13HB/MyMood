...
export function MoodSelection(){
    ...
    return(
      <View style={styles.container}>
        ...
        <TouchableOpacity activeOpacity={0.8} style={styles.moodButton} onPress={() => {navigation.navigate('Result', 1);}}>
          <FontAwesome5 name="smile-beam" size={24} color="#fff" style={styles.icon} />
          <Text style={styles.moodText}>Feliz</Text>
        </TouchableOpacity>
  
        <TouchableOpacity activeOpacity={0.8} style={styles.moodButton} onPress={() => {navigation.navigate('Result', 2);}}>
          <FontAwesome5 name="meh" size={24} color="#fff" style={styles.icon} />
          <Text style={styles.moodText}>Neutro</Text>
        </TouchableOpacity>
  
        <TouchableOpacity activeOpacity={0.8} style={styles.moodButton} onPress={() => {navigation.navigate('Result', 3);}}>
